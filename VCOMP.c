...
{
    0x0000030E, // Coefficient A1 will be multiplied with controller output u(n-1)
    0x0000FED0, // Coefficient A2 will be multiplied with controller output u(n-2)
    0x00000023  // Coefficient A3 will be multiplied with controller output u(n-3)
};

volatile int32_t VCOMP_BCoefficients [4] =
{
    0x0000753D, // Coefficient B0 will be multiplied with error input e(n-0)
    0x00009664, // Coefficient B1 will be multiplied with error input e(n-1)
    0x00008B0A, // Coefficient B2 will be multiplied with error input e(n-2)
    0x000069E4  // Coefficient B3 will be multiplied with error input e(n-3)
};
...
volatile int16_t VCOMP_pterm_factor = 0x6942;     // Q15 fractional of the P-Term factor
volatile int16_t VCOMP_pterm_scaler = 0x0006;     // Bit-shift scaler of the P-Term factor
